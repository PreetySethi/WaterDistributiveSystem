...
import com.example.wds.Adapter.CartAdapter;
import com.example.wds.Model.ProductImage;
import com.example.wds.R;

import java.util.ArrayList;

import static com.example.wds.Adapter.ProductAdapter.cartModels;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*changeAdd =(TextView) findViewById(R.id.add_change);
        changeAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CartActivity.this, CustomerAddressActivity.class);
        ...
        mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PurchaseActivity.cart_count = (temparraylist.size());
//                addItemInCart.clear();
                finish();
            }
        });
        ...
        grandTotal.setText("Qar. " + String.valueOf(grandTotalplus));
        ...
        proceedToBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CartActivity.this, CheckoutCartActivity.class);
                startActivity(intent);
